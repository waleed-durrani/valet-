...
class BuildDatabasesForTenants extends Seeder
{
    ...
    {
        $customers = [
            ['database' => 'customer_foo_tenancy', 'domain' => 'foo.multi-tenancy.dev', 'name' => 'Foo Customer', 'email' => 'customer@foo.com'],
            //['database' => 'customer_bar_tenancy', 'domain' => 'bar.multi-tenancy.dev', 'name' => 'Bar Customer', 'email' => 'customer@bar.com'],
            //['database' => 'customer_baz_tenancy', 'domain' => 'baz.multi-tenancy.dev', 'name' => 'Baz Customer', 'email' => 'customer@baz.com'],
        ];
